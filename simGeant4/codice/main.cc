...
int main(int argc, char** argv)
{
  ...
  // Material name used.
  G4String* mate = new G4String("G4_AIR");
  ...
  runManager->SetUserInitialization(new DetectorConstruction(mate));
  runManager->SetUserInitialization(new ActionInitialization(mate));
